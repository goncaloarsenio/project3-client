...
<input type="text" name="article" value={article} onChange={(e) => {setArticle(e.target.value)}}/>

<label htmlFor="name">Titulo</label>
<input type="text" name="name" value={name} onChange={(e) => {setName(e.target.value)}}/>

<label htmlFor="intro">Introdução</label>
<input type="text" name="intro" value={intro} onChange={(e) => {setIntro(e.target.value)}}/>

<label htmlFor="img">Img URL</label>
<input type="text" name="img" value={img} onChange={(e) => {setImg(e.target.value)}}/>

<label htmlFor="description">Descrição</label>
<textarea name="description" value={description} cols="30" rows="10" onChange={(e) => {setDescription(e.target.value)}}> </textarea>
