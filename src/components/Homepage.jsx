    ...
    <div className="homepage">
      ...
      <div className="section2-home">
        ...
        <p className="section2-p">
          JobCoach oferece-te um processo de coaching para que consigas enviar
          as tuas candidaturas sem medos para as empresas que mais ambicionas
          trabalhar. Ao longo das várias etapas vais ter a acesso a cursos,
          artigos, templates e muito mais...
        </p>
      </div>
      ...
      <div className="section3-home">
        <div className="section3-home-curriculo">
          ...
          <p className="p-cv">
            Escolhe o currículo que melhor se adequa à tua área e à empresa a
        ...
        <div className="section3-home-curriculo">
          ...
          <p className="p-cm">
            Mostra que queres mesmo este emprego e explica de que forma és a
        ...
        <div className="section3-home-curriculo">
          ...
          <p className="p-en">
            Prepara-te para a tua entrevista presencial ou online.
          </p>
        </div>
      </div>
      ...
      <div className="section4-home">
        ...
        <p className="section4-p">
          JobCoach dá-te acesso a vários recursos para te tornares num expert da
          procura de trabalho.
        </p>
        ...
        <div className="section4-recursos">
          <div className="recursos-small">
            ...
            <p className="recursos-small-p">
              Palestras informativas e demonstrativas de um determinados tema,
              dadas por uma entidade especializada na área.
            </p>
          </div>
          ...
          <div className="recursos-small">
            ...
            <p className="recursos-small-p">
              Cursos físicos ou online que envolvem a realização de uma tarefa
              prática relacionada com o tema lecionado.{" "}
            </p>
          </div>
          ...
          <div className="recursos-small">
            ...
            <p className="recursos-small-p">
              Conversas informativas online dadas por um orador representante de
              uma empresa.{" "}
            </p>
          </div>
        </div>
